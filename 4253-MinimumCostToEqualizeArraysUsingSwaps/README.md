...
**Difficulty:** Medium  
[View on LeetCode](https://leetcode.com/problems/minimum-cost-to-equalize-arrays-using-swaps/)
...
- `nums2` becomes `[10, 20]`. - This operation is free of charge.
...
- `nums1` becomes `[20, 10]`. - `nums2` becomes `[10, 20]`. - This operation costs 1.

- Swap `nums2[0] = 10` and `nums2[1] = 20`. - `nums2` becomes `[20, 10]`. - This operation is free of charge.

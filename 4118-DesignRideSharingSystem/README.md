...
RideSharingSystem rideSharingSystem = new RideSharingSystem(); // Initializes the system **rideSharingSystem.addRider(3); // rider 3 joins the queue  
...
RideSharingSystem rideSharingSystem = new RideSharingSystem(); // Initializes the system **rideSharingSystem.addRider(8); // rider 8 joins the queue  
